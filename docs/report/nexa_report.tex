...
\and
\IEEEauthorblockN{Ricardo Chambilla Perca}
\IEEEauthorblockA{\textit{Escuela Profesional de Ingeniería de Sistemas} \\
\textit{Universidad Nacional de San Agustín de Arequipa}\\
Arequipa, Perú \\
rchambillap@unsa.edu.pe}
\and
\IEEEauthorblockN{Paul Cari Lipe}
\IEEEauthorblockA{\textit{Escuela Profesional de Ingeniería de Sistemas} \\
\textit{Universidad Nacional de San Agustín de Arequipa}\\
Arequipa, Perú \\
pcaril@unsa.edu.pe}
\and
\IEEEauthorblockN{Jhonathan Arias}
\IEEEauthorblockA{\textit{Escuela Profesional de Ingeniería de Sistemas} \\
\textit{Universidad Nacional de San Agustín de Arequipa}\\
Arequipa, Perú \\
jarias@unsa.edu.pe}
\and
\IEEEauthorblockN{Raquel Quispe}
\IEEEauthorblockA{\textit{Escuela Profesional de Ingeniería de Sistemas} \\
\textit{Universidad Nacional de San Agustín de Arequipa}\\
Arequipa, Perú \\
rquispe@unsa.edu.pe}
...
\begin{IEEEkeywords}
Clean Architecture, TypeScript, Phaser 3, Teoría de Grafos, Algoritmo de Tarjan, Patrones de Diseño, Juegos en Tiempo Real, Arquitectura Hexagonal, SOLID
\end{IEEEkeywords}
...
La motivación principal de este proyecto es demostrar que los principios de arquitectura limpia, ampliamente adoptados en el desarrollo de aplicaciones empresariales, pueden aplicarse exitosamente al desarrollo de videojuegos sin comprometer el rendimiento ni la jugabilidad. Según Martin \cite{martin2017clean}, una arquitectura limpia debe ser independiente de frameworks, testeable, independiente de la UI, independiente de la base de datos y independiente de cualquier agente externo.
